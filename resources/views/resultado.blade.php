...
<Body>
 @csrf
<strong>Los numeros que no aparecen en la lista es porque no tienen ningun multiplo de 3,5 o 7</strong>
<ol>
    <?php foreach ($data as $item){ ?>
     <li><span style="color:<?php echo $item['color'];?>"><?php echo $item['numero'];?> :
      <?php foreach ($item['multiplos'] as $x){ ?>
         <?php echo "[". $x . "]"?>
       <?php }?>
     </span></li>
    <?php }?>
